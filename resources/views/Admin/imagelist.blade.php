...
<div id="content">
	...
	<form action="{{route('admin.imageDelete')}}" enctype="multipart/form-data" id="form-user">
    	{{csrf_field()}}
	  	<div class="page-header">
		    <div class="container-fluid">
		      <div class="pull-right"><a href="{{route('admin.imageForm')}}" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title=""><i class="fa fa-plus"></i></a>
		  	...
		  	<div class="container-fluid">
			    <div class="panel panel-default">
			      <div class="panel-heading">
			        <h3 class="panel-title"><i class="fa fa-list"></i>ALl Image List</h3>
			      </div>
			            ...
			            <table class="table table-bordered table-hover">
			              ...
			              <tbody>
			            	...
			            	<tr>
			                  ...
			                  <td class="text-left">
			                  	@if($image->image)
			                  	<img src="{{asset('images/slider')}}/{{$image->image}}" style="height: 130px;width: auto;">
			                  	 @endif
			                  </td>
