      ...
      <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="name" placeholder="Name" id="input-username" class="form-control" value="{{$admin->name}}">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="email" value="{{$admin->email}}" placeholder="Email" id="input-username" class="form-control">
              <div class="text-danger"></div>
            </div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="address" value="{{$admin->address}}" placeholder="address" id="input-username" class="form-control">
              <div class="text-danger"></div>
            </div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="number" value="{{$admin->number}}" placeholder="Phone Number" id="input-username" class="form-control">
              <div class="text-danger"></div>
            </div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="password" name="password" value="{{$admin->password}}" placeholder="Password" id="input-username" class="form-control">
              <div class="text-danger"></div>
            </div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="password" name="confirm_password" value="{{$admin->password}}" placeholder="Confirm Password" id="input-username" class="form-control">
              <div class="text-danger"></div>
            </div>
          </div>
          @endforeach
