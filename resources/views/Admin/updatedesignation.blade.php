      ...
      <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="heading" placeholder="Heading Title" id="input-username" class="form-control" value="{{$desg->heading}}">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="file" name="image" placeholder="" id="input-username" class="form-control" value="{{$desg->image}}">
              <div class="text-danger"></div>
            </div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <textarea class="summernote" rows="50" cols="50" name="description">{!!$desg->description!!}</textarea>
              <div class="text-danger"></div>
            </div>
          </div>
          @empty
